...
if($action=='add'){
    ...
    header('location:uploadFavicon.php');
    exit();
...
<html lang="en">
 ...
 <body>
  <form name="form1" method="post" action="uploadFavicon.php" enctype="multipart/form-data">
...
<?php
    ...
    foreach($result as $val){
        echo '<p><img src=uploadFavicon.php?action=show&id='.$val['id'].'&t='.time().'" width="150"></p>';
    }
?>
